...
class Ajax extends Backend
{
    ...
    public function upload()
    {
        ...
        if ($splInfo) {
            ...
            //生成缩略图
            $image_thumb = Image::open($splInfo->getPathname());
            $image_thumb->thumb(100, 100, \think\Image::THUMB_CENTER)->save(ROOT_PATH . '/public' . $uploadDir . $splInfo->getSaveName() . '.thumb.jpg');
