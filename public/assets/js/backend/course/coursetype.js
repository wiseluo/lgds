define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'course/coursetype/index' + location.search,
                    add_url: 'course/coursetype/add',
                    edit_url: 'course/coursetype/edit',
                    del_url: 'course/coursetype/del',
                    multi_url: 'course/coursetype/multi',
                    table: 'course_type',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'course/coursetype/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
