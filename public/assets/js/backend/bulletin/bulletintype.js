define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'bulletin/bulletintype/index' + location.search,
                    add_url: 'bulletin/bulletintype/add',
                    edit_url: 'bulletin/bulletintype/edit',
                    del_url: 'bulletin/bulletintype/del',
                    multi_url: 'bulletin/bulletintype/multi',
                    table: 'bulletin_type',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'bulletin/bulletintype/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'bulletin/bulletintype/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'bulletin/bulletintype/destroy',
                                    refresh: true
                                }
                            ],
