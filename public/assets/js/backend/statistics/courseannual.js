define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'statistics/courseannual/index',
                    table: 'courseperiods',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        {field: 'annual', title: __('Annual'),operate: 'BETWEEN', addclass:'datetimepicker',data:'autocomplete="off" data-date-format="YYYY"'},
